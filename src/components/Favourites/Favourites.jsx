...
const Favourites = () => {
  ...
  return (
    ...
    <div>
      {favourites.length === 0 ? (
        <Box sx={{ width: '100vh', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingLeft: "20%", paddingRight: "25%", color: "#504E4D" }}>
          {/* <div> */}
          <div style={{ display: 'flex', flexDirection: 'column', rowGap: 15 }}>
            <h1 style={{ color: "#504E4D", marginBottom: "1rem" }}>Hmmm... </h1>
            <p style={{ fontWeight: "bold", color: "#504E4D", marginBottom: "1rem" }}>You don't have any favourites.</p>
            <p style={{ color: "#504E4D" }}>Please add some favourites to save them here.</p>
            <Link to="/">
